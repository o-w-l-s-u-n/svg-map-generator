...
const translations: Record<Locale, Messages> = {
  en: {
    ...
    map: {
      ...
      previewStatus: {
        rendering: "Rendering PNG preview…",
      ...
      downloadHeading: "3. Download the SVG",
  ...
  ru: {
    ...
    map: {
      ...
      previewStatus: {
        rendering: "Рендерим PNG-превью…",
        error: "Не удалось отрисовать превью.",
        idle:
          "Создайте превью, чтобы увидеть растровую версию SVG.",
      },
      ...
      downloadHeading: "3. Скачайте SVG",
      downloadButton: "Скачать SVG",
      downloadHint:
        "Скачивание всегда использует полноразмерный SVG, возвращённый сервером.",
      poweredBy:
